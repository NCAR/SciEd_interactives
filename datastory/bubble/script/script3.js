...
var xScale = d3.scale.linear().domain([1960,2020]).range([0, width]),
    yScale = d3.scale.linear().domain([yMin,yMax]).range([height, 0]),
    radiusScale = d3.scale.sqrt().domain([0, 53526303]).range([0, 100]),
...
var label = svg.append("text")
    ...
    // Load the data.
    d3.json("data/extract_data_regions.php", function(nations) {
